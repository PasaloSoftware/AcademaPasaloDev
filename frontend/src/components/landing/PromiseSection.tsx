    ...
    <section className="px-6 md:px-16 lg:px-28 py-20 bg-bg-primary flex flex-col items-center gap-10">
      ...
      <div className="w-full flex flex-col items-center gap-4 px-5">
        <div className="w-full flex flex-col gap-4">
          <h3 className="text-center text-magenta-violet-600 text-2xl font-bold leading-7">
            NUESTRA PROMESA
          </h3>
          <h2 className="text-center text-text-primary text-3xl md:text-5xl font-bold leading-tight md:leading-[56px]">
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {cards.map((card) => (
          <div
            key={card.title}
            className="p-4 bg-bg-primary rounded-lg card-shadow outline outline-1 outline-offset-[-1px] outline-stroke-secondary flex flex-col gap-3"
          >
            <div
            ...
            <h4 className="text-text-primary text-lg font-medium leading-5">
              {card.title}
            </h4>
