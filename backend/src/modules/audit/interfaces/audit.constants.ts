...
export const AUDIT_EXCEL_CONFIG = {
  ...
  COLUMNS: {
    ...
    LOCATION_SOURCE: 'FUENTE UBICACION',
    CITY: 'CIUDAD',
    COUNTRY: 'PAIS',
    ACTIVE_ROLE_CODE: 'ROL AL MOMENTO',
    SESSION_STATUS: 'ESTADO SESION',
    NEW_SESSION_ID: 'ID NUEVA SESION',
    EXISTING_SESSION_ID: 'ID SESION EXISTENTE',
    EXISTING_DEVICE_ID: 'ID DISPOSITIVO EXISTENTE',
  },
} as const;
