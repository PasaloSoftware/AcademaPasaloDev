...
function getBankFolderDefinition(
  ...
  if (code === 'LAB') {
    return { folderName: 'Laboratorios', prefix: 'LAB' };
  }
  if (code === 'PC') {
    return { folderName: 'Practicas Calificadas', prefix: 'PC' };
  }
  if (code === 'PD') {
    return { folderName: 'Practicas Dirigidas', prefix: 'PD' };
  }
  if (code === 'EX') {
    return { folderName: 'Examenes', prefix: 'EX' };
  }
  return {
